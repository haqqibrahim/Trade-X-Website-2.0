    ...
    <>
      <div className="bg-[#252425] mt-12" style={styles.mck}>
        <div className="lg:ml-36 pt-16">
          <h1 className="text-left font-sans" style={styles.textColor}>
            TRADE-X OPPORTUNITY
          </h1>
          <h1 className="text-white lg:text-3xl text-left pt-8 font-sans font-semibold">
            40% of the Global
          </h1>
          <h1 className="text-white lg:text-3xl text-left font-sans font-semibold">
            Consumer population
          </h1>
          <div className="pt-5">
            <p className="text-white font-sans text-left font-semibold">
          ...
          <div className="pt-5">
            <div className="flex space-x-2">
              ...
              <div>
                <p className="text-white font-sans text-left pt-0.5">
            ...
            <div className="flex space-x-2">
              ...
              <div>
                <p className="text-white font-sans text-left pt-0.5">
                  We have an indirect spending power of $600 Billion
                </p>
              </div>
            </div>
            <div className="flex space-x-2">
              ...
              <div>
                <p className="text-white font-sans text-left pt-1">
